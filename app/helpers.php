...
if (! function_exists('error')) {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    function error($message = '', $errors = [], $code = 400)
    {
...
if (! function_exists('unauthenticated')) {
    ...
    {
        return error($message, $errors, 401);
    }
}
if (! function_exists('forbidden')) {
    ...
    {
        return error($message, $errors, 403);
    }
}
if (! function_exists('not_found')) {
    ...
    {
        return error($message, $errors, 404);
    }
}
if (! function_exists('method_not_allowed')) {
    ...
    {
        return error($message, $errors, 405);
    }
}
if (! function_exists('not_acceptable')) {
    ...
    {
        return error($message, $errors, 406);
    }
}
if (! function_exists('teapot')) {
    ...
    {
        return error($message, $errors, 418);
    }
}
