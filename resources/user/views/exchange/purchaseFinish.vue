                        ...
                        <b-row>
                            ...
                            <b-col cols="2" class="text-truncate">
                                <div class="float-right" style="height: 63px; line-height: 63px;">
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm align-middle">Lihat Detail</button>
                                    </router-link>
                                </div>
                            </b-col>
                        </b-row>
                    ...
                    <b-row>
                        <b-col cols="4" class="text-truncate">
                            ...
                            <template  v-for="order_item in item.order_item">
                                <div :key="order_item.id" class="pt-2">
                                    ...
                                    <router-link class="product-click" :to="'/'+item.store.store_url+'/'+order_item.product_id+'/'+order_item.product.name|Slug">
                        ...
                        <b-col cols="2" class="float-right"> 
                            <div class="float-right form-group">
                                <div>
                                    <button v-if="item.order_status_id == 23" type="button" class="btn btn-outline-primary btn-sm align-middle mt-2">Terima Barang</button>
                                    <button v-if="item.order_status_id == 24" type="button" class="btn btn-outline-primary btn-sm align-middle mt-2">Tulis Ulasan</button>
                                </div>
                                <div>
                                    <button v-if="item.order_status_id == 23" type="button" class="btn btn-block btn-outline-danger btn-sm align-middle mt-2">Komplain</button>
                                    <button v-if="item.order_status_id == 24" type="button" class="btn btn-block btn-outline-danger btn-sm align-middle mt-2">Beli Lagi</button>
                                </div>
                            </div>
                        </b-col>
                    </b-row>
