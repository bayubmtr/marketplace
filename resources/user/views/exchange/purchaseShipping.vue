                ...
                <b-card :key="item.id" class="mt-2">
                        ...
                        <b-row>
                            ...
                            <b-col cols="4" class="text-truncate">
                                <div>
                                    ...
                                    <span v-if="item.order_status_id == 4" class="badge badge-primary">Sedang Dikirim</span>
                                    <span v-else class="badge badge-success">Sudah Sampai</span>
                            </b-col>
                            <b-col cols="2" class="text-truncate">
                    ...
                    <b-row>
                        ...
                        <b-col cols="6" class="text-truncate">
                                ...
                                <div>
                                    <span>{{item.order_shipment_detail.tracking_number}}</span>
                                </div>
                                <span class="mouse-pointer text-primary" v-on:click="cekResi(item.order_shipment_detail.tracking_number)">Lacak Barang</span>
                            </b-col>
                    </b-row>
                </b-card>
            </template>
